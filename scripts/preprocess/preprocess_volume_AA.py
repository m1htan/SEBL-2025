...
OUTPUT_DIR = "/Users/minhtan/Documents/GitHub/SEBL-2025/data/data_clean/volume_AA"
os.makedirs(OUTPUT_DIR, exist_ok=True)

raw_volume_A = os.path.join(DATA_RAW_DIR, 'SMEs resource efficiency green markets_fl_549_volume_AA.xlsx')
