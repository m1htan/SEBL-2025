...
csv_files = {
    "total": "/Users/minhtan/Documents/GitHub/SEBL-2025/data/final/ai_agent/scaled_score_for_scale_full_group_country_6_part_ratio.csv"
}

output_plot_dir = "/Users/minhtan/Documents/GitHub/SEBL-2025/output/ai_agent/all/plots"
os.makedirs(output_plot_dir, exist_ok=True)

output_stats_dir = "/Users/minhtan/Documents/GitHub/SEBL-2025/output/ai_agent/all/descriptive_statistics"
...
for group, path in csv_files.items():
    ...
    desc.to_csv(os.path.join(output_stats_dir, f"ai_agent_all_{group}_describe.csv"), header=True)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(output_plot_dir, f"ai_agent_all_{group}_hist.png"))
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_plot_dir, f"ai_agent_all_{group}_qq.png"))
    plt.close()
...
summary_df.to_csv(os.path.join(output_stats_dir, "ai_agent_all_summary_all_groups.csv"), index=False)
