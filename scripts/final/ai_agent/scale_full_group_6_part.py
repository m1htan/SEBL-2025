...
def save_final_score_to_db(df_final: pd.DataFrame, engine):
    table_name = "scaled_score_for_scale_full_group_country_6_part_ratio"
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(OUTPUT_DIR, "scaled_score_for_scale_full_group_country_6_part_ratio.csv")
