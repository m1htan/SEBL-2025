...
OUTPUT_DIR = "/Users/minhtan/Documents/GitHub/SEBL-2025/data/final/ratio_46"
...
def save_groups_to_db(df_final: pd.DataFrame, engine):
    for group_id, group_df in df_final.groupby("group_id"):
        table_name = f"scaled_score_for_4_part_ratio_country_group{group_id}"
...
if __name__ == "__main__":
    ...
    for group_id, group_df in df_final.groupby("group_id"):
        output_path = os.path.join(OUTPUT_DIR, f"scaled_score_for_4_part_ratio_country_group{group_id}.csv")
